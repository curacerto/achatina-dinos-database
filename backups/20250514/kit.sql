...
INSERT INTO dinos.kit (id, name, price, description, icon) VALUES (4, 'explorernotes', 40000, 'By buying this you will unlock all explorer notes from the game and it will be enabled after relogging', 'notes.png');
